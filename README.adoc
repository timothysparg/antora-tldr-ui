...
Vite (configured in [.path]_vite.build.config.ts_) handles the JS/CSS build pipeline, while Mise tasks coordinate template copies, Antora preview builds, and packaging.
