...
const pages = {
	...
	"/getting-started-asciidoc.html": () =>
		import("./getting-started-asciidoc.adoc").then((module) => module.default),
	"/advanced-formatting.html": () =>
		import("./advanced-formatting.adoc").then((module) => module.default),
	"/static-sites.html": () =>
		import("./static-sites.adoc").then((module) => module.default),
	"/documentation-best-practices.html": () =>
		import("./documentation-best-practices.adoc").then(
			(module) => module.default,
		),
	"/kitchensink.html": () =>
		import("./kitchensink.adoc").then((module) => module.default),
...
console.log(
	"Preview site loaded with Vite + AsciiDoc + Handlebars integration",
);
